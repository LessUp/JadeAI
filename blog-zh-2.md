...
> GitHub Pages：https://lessup.github.io/JadeAI | GitHub：https://github.com/LessUp/JadeAI
...
- **GitHub Pages 首页**：访问 [lessup.github.io/JadeAI](https://lessup.github.io/JadeAI) 查看项目介绍、部署入口和仓库链接。
- **自托管部署**：先在本地构建镜像，再运行（`docker build -t jadeai-local:latest . && docker run -d -p 3000:3000 -e AUTH_SECRET=<密钥> -v jadeai-data:/app/data jadeai-local:latest`），也可以本地 clone 源码开发。
...
![AI 优化](images/ai%20优化.png)

![AI 语法检查](images/AI%20语法检查.png)

![JD 匹配分析](images/JD%20匹配分析.png)

- **生成职业照**：上传一张普通照片，选择尺寸和背景样式，AI 生成专业的职业证件照，直接下载使用。

![AI 职业照生成](images/职业照生成.png)
...
![多格式导出](images/多项导出.png)

![创建分享链接](images/创建分享链接.png)
...
- **开源协议**：Apache 2.0
- **GitHub Pages**：https://lessup.github.io/JadeAI
- **GitHub**：https://github.com/LessUp/JadeAI
